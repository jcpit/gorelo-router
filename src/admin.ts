...
<body>
  ...
  <script nonce="__CSP_NONCE__">
    ...
    function validGoreloCatalogItem(kind,item) {
      ...
      if (kind==="agent-assets") return typeof item.id==="string"&&/^[0-9a-f]{8}-[0-9a-f]{4}-[1-8][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i.test(item.id);
