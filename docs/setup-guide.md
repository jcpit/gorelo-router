...
| Gorelo **Test connection** fails                            | Check the exact regional origin, secret presence, current key scopes, and Gorelo availability. The UI never receives the key value.                                                                                          |
